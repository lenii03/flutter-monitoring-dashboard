...
class MainContentWidget extends StatelessWidget {
            ...
            children: [
              ...
              if (selectedIndex == 2)
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.serverOnline, // Pakai warna hijau
                    foregroundColor: Colors.white,
                    padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
                  ),
                      ...
                      Row(
                        ...
                        children: List.generate(20, (index) {
                          ...
                          return AnimatedContainer(
                            ...
                            height: height,
                            decoration: BoxDecoration(
                              color: AppColors.primaryBlue.withOpacity(height > 150 ? 1.0 : 0.4),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          index == 0 ? 'Service_3 failed to respond' : 'Scheduled task completed',
                                          style: TextStyle(color: index == 0 ? AppColors.serverOffline : AppColors.textPrimary, fontSize: 14),
                                        ),
  ...
  Widget _buildSettingsPage() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildSettingsSectionHeader('Preferences', Icons.tune_rounded),
          const SizedBox(height: 16),
          _buildSettingCard(
            children: [
              _buildSwitchTile('Email Notifications', 'Receive daily digest and critical alerts', true),
              const Divider(color: AppColors.border, height: 1),
              _buildSwitchTile('Push Notifications', 'Real-time alerts for server downtime', false),
              const Divider(color: AppColors.border, height: 1),
              _buildSwitchTile('Dark Mode', 'Use dark theme across the dashboard', true),
            ],
          ),
          
          const SizedBox(height: 32),
          
          _buildSettingsSectionHeader('Server Configuration', Icons.dns_rounded),
          const SizedBox(height: 16),
          _buildSettingCard(
            children: [
  ...
  Widget _buildSwitchTile(String title, String subtitle, bool value) {
    return SwitchListTile(
      ...
      onChanged: (bool newValue) {}, // Nanti disambung ke BLoC
    );
  }
